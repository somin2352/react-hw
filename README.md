...
- 최소 수량(1) 최대 수량(max)에 따른 버튼 비활성화
  <img src='./public/readme-img/cart-count-button_img1.png' width='300px'>

- useState를 통해 현재 수량 상태(count) 저장
  <img src='./public/readme-img/cart-count-button_img2.png' width='300px'>

- onUpdate 함수를 통해 count 상태 끌어올리기
  <img src='./public/readme-img/cart-count-button_img3.png' width='200px'>
...
- toLocaleString()을 사용하여 가격 정보 기재
  <img src='./public/readme-img/cart-item_img1.png' width='300px'>

- onUpdate 함수를 통해 count 상태 전달
  <img src='./public/readme-img/cart-item_img2.png' width='300px'>

3. cart

- productList에 상품 데이터 저장
  <img src='./public/readme-img/cart_img1.png' width='250px'>

- useState를 사용해 초기 상품 수량(productCount, initialCount) 저장
  <img src='./public/readme-img/cart_img2.png' width='300px'>

- map()을 사용하여 상품 정보 렌더링
  <img src='./public/readme-img/cart_img3.png' width='200px'>

- onUpdate 상태 끌어올리기를 통해 count 상태 정보를 productCount 상품 수량에 업데이트
  <img src='./public/readme-img/cart_img4.png' width='300px'>
  <img src='./public/readme-img/cart_img5.png' width='300px'>

- reduce()를 사용해 상품 총액(totalPrice) 업데이트
  <img src='./public/readme-img/cart_img6.png' width='300px'>
